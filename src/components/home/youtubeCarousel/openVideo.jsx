...
export default function OpenVideo({ title, description, videoSrc }) {
  return (
    <Dialog>
      ...
      <DialogContent
        className={
          "h-full max-h-[60vh] w-full max-w-[90vw] md:max-w-[80vw] lg:max-w-[50vw] overflow-hidden flex flex-col items-start gap-2 rounded-md text-main-black px-5 md:px-8 pt-12 pb-5 md:pb-8 2xl bg-main-white border-none"
        }
      >
        ...
        <DialogHeader className={"text-text-black flex flex-col items-start text-start gap-1"}>
