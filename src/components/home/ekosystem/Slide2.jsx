...
export default function Slide2({ classNames, index }) {
  return (
    ...
    >
      ...
      <div className="order-2 md:order-1 relative flex-1 w-full min-h-[50%] lg:min-h-auto h-full rounded-xl overflow-hidden lg:pt-12">
        <Slide2Rive />
        <DotBackgroundDemo />
      </div>
      <div className="order-1 md:order-2 w-full h-full max-w-full lg:max-w-[42%] flex flex-col items-start justify-between gap-2 p-5 md:p-10 text-text-black">
        <div className="w-full flex flex-col items-start gap-2">
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-medium mb-4">WeeGold Network Nedir?</h2>
