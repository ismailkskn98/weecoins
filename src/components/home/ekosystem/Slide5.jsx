...
export default function Slide5({ classNames, index }) {
  return (
    <article
      className={`w-full max-w-[1100px] mx-5 h-[65vh] rounded-2xl sticky flex items-start justify-center gap-8 bg-main-white p-3 overflow-hidden ${classNames}`}
      style={{
    ...
    >
      ...
      <div className="w-full h-full max-w-[50%] flex flex-col items-start justify-between gap-2 p-9 text-text-black">
        <div className="w-full flex flex-col items-start gap-2">
          <h2 className="text-5xl font-medium mb-4">WeeCard</h2>
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            >
              <span className="inline-block bg-main-white absolute -left-[1.5px] top-1/2 -translate-y-1/2 w-[3px] h-4"></span>
              <span className="inline-block bg-main-white absolute -right-[1.5px] top-1/2 -translate-y-1/2 w-[3px] h-4"></span>
              <span className="inline-block bg-main-white absolute left-1/2 top-[-1.5px] -translate-x-1/2 w-4 h-[3px]"></span>
              <span className="inline-block bg-main-white absolute left-1/2 bottom-[-1.5px] -translate-x-1/2 w-4 h-[3px]"></span>
        ...
        <div className="mt-6 text-2xl font-semibold tracking-widest text-main-white [font-feature-settings:'zero'] p-2 rounded-xl bg-main-black">05</div>
      </div>
