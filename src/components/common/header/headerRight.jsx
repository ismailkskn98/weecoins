...
export default function HeaderRight({ classNames }) {
  return (
    <article className={`w-full h-full flex items-center justify-end gap-4 ${classNames}`}>
      <Link
        href="https://backoffice.weecoins.org/login"
        className="relative group overflow-hidden flex items-center gap-1 bg-background text-text-black px-2 lg:px-3 py-1.5 lg:py-2 text-xs sm:text-sm rounded-sm before:absolute before:uppercase before:content-['Backoffıce'] before:top-1/2 before:-translate-y-12 before:left-1/2 before:-translate-x-1/2 before:transition-all before:duration-300 hover:before:-translate-y-1/2 before:transform"
      >
